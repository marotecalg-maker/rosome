...
class AppLocalizations {
  ...
  static const Map<String, String> _en = {
    ...
    'episodes': 'Episodes',
    'episode': 'Episode',
    'no_episodes': 'No playable episodes found for this title.',
    'see_all_episodes': 'See all episodes',
    'web_playback_unsupported':
        'Playback is not available in the web preview. Install the app to watch episodes.',
    'ts_status': 'Status',
    ...
    'attribution':
        'Anime data by Jikan / MyAnimeList. All artwork belongs to its owners. Anime Slayer Max branding is original.',
    'retry': 'Retry',
    'aura': 'Aura',
  ...
  static const Map<String, String> _fr = {
    ...
    'episodes': 'Épisodes',
    'episode': 'Épisode',
    'no_episodes': 'Aucun épisode disponible pour ce titre.',
    'see_all_episodes': 'Voir tous les épisodes',
    'web_playback_unsupported':
        'La lecture n’est pas disponible dans l’aperçu web. Installez l’application pour regarder les épisodes.',
    'ts_status': 'Statut',
    ...
    'attribution':
        "Données par Jikan / MyAnimeList. Les visuels appartiennent à leurs ayants droit. L'identité Anime Slayer Max est originale.",
    'retry': 'Réessayer',
    'aura': 'Aura',
  ...
  static const Map<String, String> _ar = {
    ...
    'episodes': 'الحلقات',
    'episode': 'الحلقة',
    'no_episodes': 'لا توجد حلقات متاحة لهذا العنوان.',
    'see_all_episodes': 'كل الحلقات',
    'web_playback_unsupported':
        'التشغيل غير متاح في نسخة الويب. ثبّت التطبيق باش تتفرّج على الحلقات.',
    'ts_status': 'الحالة',
    ...
    'help_support': 'الدعم',
    'attribution':
        'البيانات من Jikan / MyAnimeList. جميع الصور ملك لأصحابها. هوية Anime Slayer Max أصلية.',
